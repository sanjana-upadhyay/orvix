...
const categoryStyles = {
  ...
  "system-design": "bg-gray-100 text-gray-600",
      ...
      <main className="min-h-screen bg-white px-4 py-10">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-extrabold text-gray-900">Practice History</h1>
          </div>
          ...
          {streak > 0 && (
            <motion.div
              ...
              className="bg-teal-50 rounded-3xl p-4 mb-6 flex items-center gap-3 border border-teal-100"
            >
              <div className="w-10 h-10 rounded-xl bg-teal-600 flex items-center justify-center text-white font-extrabold text-sm">
                {streak}
              </div>
              <div>
          ...
          {sessions.length === 0 ? (
            <p className="text-gray-400 text-center mt-16 text-sm font-bold">
            ...
            <>
              <div className="space-y-3">
                {sessions.map((s, i) => (
                  <motion.div
                    ...
                    className="bg-white rounded-2xl p-4 flex items-center justify-between border border-gray-200 hover:border-gray-300 transition shadow-sm"
                  >
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <p className="font-extrabold text-gray-900 text-sm">{s.role}</p>
                        {s.category && (
              ...
              <button
                ...
                className="mt-8 text-xs text-red-500 hover:text-red-600 underline font-bold"
              >
                Clear all history
              </button>
            </>
